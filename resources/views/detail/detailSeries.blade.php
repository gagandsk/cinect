...
@section('content')
    ...
    <section class="container">
        <div class="container-fluid d-flex justify-content-between align-items-center">
            ...
            <a href="{{ url('/content/contentSeries') }}" class="btn button-purple my-4">
            {{ trans('titles.back') }}
            </a>
        </div>
                    ...
                    <div class="dropdown my-sm-2">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            @foreach ($userLists as $list)
                                <li>
                                    <a class="dropdown-item" href="/detail/detailSeries/{{ $serie->id }}/{{ $list->id }}/addFav">{{ $list->name }}</a>
                                </li>
                            @endforeach
                        </ul>
                    </div>
                    ...
                    <div class="modal fade" id="myModal">
                        <div class="modal-dialog text-dark">
                            <div class="modal-content">
                                <form method="POST" action="/detail/detailSeries/{{ $serie->id }}/addNewList">
                                    @csrf
                    ...
                    <div class="dropdown mx-2 mt-sm-2">
                            ...
                            <ul class="dropdown-menu">
                                @foreach ($userListsWhereSerie as $list)
                                    <li>
                                        <a class="dropdown-item" href="/detail/detailSeries/{{ $serie->id }}/{{ $list->id }}/delFav">{{ $list->name }}</a>
                                    </li>
                                @endforeach
                            </ul>
                        </div>
