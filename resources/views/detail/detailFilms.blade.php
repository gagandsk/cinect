...
@section('content')
    ...
    <section class="container">
        <div class="container-fluid d-flex justify-content-between align-items-center">
            ...
            <a href="{{ url('/content/contentFilms') }}" class="btn button-purple my-4">
            {{ trans('titles.back') }}
            </a>
        </div>
            ...
            <article class="col-6 more-info bg-dark p-3 ms-1 ms-sm-0" id="datasheet">
                ...
                @else
                    <div class="d-flex flex-column align-items-start mt-2">
                        ...
                        <form method="POST" class="d-flex flex-column align-items-center col-12 mb-xl-2" action="{{ route('user.add_rating_film', ['idFilm' => $film->id]) }}">
                            @csrf
                    ...
                    <div class="modal fade" id="myModal">
                        <div class="modal-dialog text-dark">
                            <div class="modal-content">
                                <form method="POST" action="/detail/detailFilms/{{ $film->id }}/addNewList">
                                    @csrf
